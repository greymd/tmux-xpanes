...
#     if (is_less_than_or_equal_to "1.9");then
...
test_start_separation() {
    ...
    echo "( is_less_than_or_equal_to "1.7" )"
    ( is_less_than_or_equal_to "1.7" )
    echo $?
    ...
    if ( is_less_than_or_equal_to "1.7" ) ;then
        echo 'In if less than'
    fi
